...
uint16 extension_model_groups[MAX_MODEL_GROUPS];
uint16 grp_model_groups[MAX_MODEL_GROUPS];
/*#ifdef ENABLE_DATA_MODEL*/
/* Device info string */
/*#define DEVICE_INFO_STRING               "CSRmesh 2.1 Light\r\n" \
                                         "Supported Models:\r\n" \
                                         " Light Model\r\n" \
                                         " Power Model\r\n" \
                                         " Attention Model\r\n" \
...
/* The function is called to check whether the app is associated or not */
