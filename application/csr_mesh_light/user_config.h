...
#define MAX_MODEL_GROUPS        (35) //default:35 or max:340

/* Number of TIMER */
#define MAX_MODEL_TIMER         (5)

/*Number of SCENE*/
#define MAX_MODEL_SCENES        (0)
...
/*Enable Extension model support*/
#define ENABLE_EXTENSION_MODEL

#define MAX_EXT_OPCODE_RANGE_SUPPORTED   (1)
